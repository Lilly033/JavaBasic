...
//How would you find out how many sentences are in that String?
	...
	System.out.println(s.length());//string class method to count the number of characters
	    //	in a clas
	System.out.println(s.split("[?]").length); //length proporty that we can use to check
